        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <a href= <?php echo base_url("index.php/mahasiswa/delete/$mhs->id")?> class="btn btn-danger btn-lg active" onclick="return hapusMahasiswa('Anda Yakin Akan Menghapus Data Yang Bernama <?php echo $mhs-> nama ?>?')">Hapus</a>
                </td>
            </tr>
            <?php
            $nomor++;
