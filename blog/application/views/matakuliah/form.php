...
<h1>Form Imput Matakuliah</h1>
<?php echo form_open("matakuliah/save") ?>
  <div class="form-group row">
    <label for="nama_matkul" class="col-4 col-form-label">nama</label> 
    <div class="col-8">
      <input id="nama_matkul" name="nama_matkul" placeholder="Masukan nama" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="SKS" class="col-4 col-form-label">SKS</label> 
    <div class="col-8">
      <input id="SKS" name="SKS" placeholder="Masukan SKS" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
