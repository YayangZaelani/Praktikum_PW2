        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <a href= <?php echo base_url("index.php/dosen/delete/$dsn->id")?> class="btn btn-danger btn-lg active" onclick="return hapusDosen('Anda Yakin Akan Menghapus Data Yang Bernama <?php echo $dsn-> nama ?>?')">Hapus</a>
                </td>
            </tr>
            <?php
            $nomor++;
